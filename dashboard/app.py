...
DB_PATH = os.getenv("DATABASE_PATH", "/app/shared/trades_v17.db")
...
def dashboard():
    ...
    strategy_specs = []
    try:
        specs_raw = redis_client.smembers("strategy_registry")
        strategy_specs = [json.loads(s) for s in specs_raw]
    except (json.JSONDecodeError, redis.RedisError):
        pass
